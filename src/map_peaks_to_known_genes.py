...
def parse_known_genes_file(file_object):
	"""
	...
	known_genes_file_reader = DictReader(file_object, delimiter='\t', fieldnames=known_genes_file_fieldnames)


def parse_peaks_file(file_object):
	"""
	...
	peaks_file_fieldnames = ["chrom","chromStart","chromEnd","name","score","strand","thickStart","thickEnd","itemRgb","blockCount","blockSizes","blockStarts"]

	peaks_file_reader = DictReader(file_object, delimiter='\t', fieldnames=peaks_file_fieldnames)



def parse_kgXref_file(file_object):
	"""
	"""

	kgXref_file_fieldnames = ['kgID','mRNA','spID','spDisplayID','geneSymbol','refseq','protAcc','description']

	kgXref_reader = DictReader(file_object, delimiter='\t', fieldnames=kgXref_file_fieldnames)
...
def group_by_chromosome(dictionary):
	"""
	"""
